...
class Plugin extends BasePlugin
{
     ...
     */
    protected function initRedactor()
    {
        ...
        if (is_dir($redactor_config)) {
            if (!is_dir($redactor_plugins)) {
                mkdir($redactor_plugins);
            }

            if (!is_file($redactor_plugin_file)) {
                file_put_contents($redactor_plugin_file, '// Auto-generated by Promptly');
            }
        }
    }
